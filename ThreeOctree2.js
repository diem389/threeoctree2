...
export let addOctreeToThree = function(THREE) {
  ...
  THREE.Octree.prototype = {
    ...
    addObjectData: function(object, part) {
      let objectData = new THREE.OctreeObjectData(object, part);
    ...
    rebuild: function() {
      ...
      for (i = 0, l = this.objectsData.length; i < l; i++) {
        ...
        if (node instanceof THREE.OctreeNode &&
  ...
  THREE.OctreeNode.prototype = {
    ...
    checkMerge: function() {
      ...
      // under minimum
      while (nodeParent.parent instanceof THREE.OctreeNode &&
    ...
    checkContract: function() {
      ...
      if (this.nodesIndices.length > 0) {
        ...
        for (i = 0, l = this.nodesIndices.length; i < l; i++) {
          ...
          if (nodeHeaviest instanceof THREE.OctreeNode === false ||
        ...
        if (outsideHeaviestObjectsCount < this.tree.objectsThreshold &&
            nodeHeaviest instanceof THREE.OctreeNode) {
